...
public record SummaryThemeCandidate(String id,String displayTheme,Level level,DisplaySource displaySource,List<String> groupIds,List<String> memberProjects,
  ...
  public enum DisplaySource { PROJECT, THEME_GROUP, GENERIC_THEME }
