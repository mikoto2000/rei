...
- [ ] 2. `ImageGenerationRequest` / `ImageGenerationResult` を追加する
...
- [ ] 5. `ImageGenerationClient` の境界を定義する
...
- [ ] 6. `ImageGenerationService` の正常系を実装する
...
- [ ] 7. `ImageGenerationService` の異常系を実装する
...
- [ ] 8. Spring AI 連携用 `ImageModelProvider` を実装する
...
- [ ] 10. `OpenAiImageGenerationClient` を実装する
...
- [ ] 12. 設定ファイルと config template を更新する
